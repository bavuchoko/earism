  ...
  <body>
    ...
    <div id="myinfo">
            ...
            <div id="maininfo">
                ...
                <p class="email">${sessionScope.id}  &nbsp;<a href="emailauth.do"><i class="fas fa-question-circle" style="color:red;"></i></a></p>
                    </c:when>
    ...
    <div id="market">
        <div id="circlechart" style="width: 300px; height: 300px"></div>
        <div id="mysale"></div>
    </div>

        <form name="musicuploader" action="fileUploader.do" method="post" enctype="multipart/form-data">
            <p id="uptag">등록하기</p>
            <div id="upload">
                <div id="uploadcover imgViewArea">
                    <label for="artwork"><img id="imgArea" class="upcover" src="imgs/xxxmusic.png" onerror="imgAreaError()"></label>
                    <input id="artwork" name="album_artwork" style="display:none" type="file" accept="image/*">
                </div>
                <div id="upinfo">
                    <div>
                        <ul>
                            <li>
                                ...
                                <input name="title" type="text" id="inp" placeholder="&nbsp;">
                                <span class="label">Title</span>
                                <svg width="120px" height="23px" viewBox="0 0 120 26">
                            ...
                            <li>
                                ...
                                <input name="album" type="text" id="inp2" placeholder="&nbsp;">
                                <span class="label2">Album</span>
                                <svg width="120px" height="23px" viewBox="0 0 120 26">
                                    <path d="M0,25 C21,25 46,25 74,25 C102,25 118,25 120,25"></path>
                                </svg>
                                <span class="border"></span>
                            ...
                            <li>
                                <label class="songupload" for="songfile">Music File</label>
                                <input id="songfile" name="songfile" style="display:none" type="file" accept="audio/*">
                            </li>
                        </ul>
                    </div>
                </div>
                <div id="upinfo">   
                    <div>
                        <ul>
                            <li>
                                <label for="inp3" class="inp3">
                                <input name="writer" type="text" id="inp3" placeholder="&nbsp;">
                                <span class="label3">Song Writer</span>
                                <svg width="120px" height="23px" viewBox="0 0 120 26">
                                    <path d="M0,25 C21,25 46,25 74,25 C102,25 118,25 120,25"></path>
                                </svg>
                                <span class="border"></span>
                            ...
                            <li>
                                ...
                                <input name="lyricist" type="text" id="inp4" placeholder="&nbsp;">
                                <span class="label4">lyricist</span>
                                <svg width="120px" height="23px" viewBox="0 0 120 26">
                                    <path d="M0,25 C21,25 46,25 74,25 C102,25 118,25 120,25"></path>
                                </svg>
                                <span class="border"></span>
                            ...
                            <li>
                                <label for="inp5" class="inp5">
                                <input name="singer" type="text" id="inp5" placeholder="&nbsp;">
                                <span class="label5">Singer</span>
                ...
                <div id="upinfo2">    
                    <div class="cntr">
                        ...
                        <label for="opt1" class="radio">
                            <input type="radio" name="genre" value="dance" id="opt1" class="hidden"/>
                            <span class="label2"></span>Dance
                        </label>

                    <label for="opt2" class="radio">
                            <input type="radio" name="genre" value="band" id="opt2" class="hidden"/>
                            <span class="label2"></span>Band
                        </label>
                        
                        <label for="opt3" class="radio">
                            <input type="radio" name="genre" value="hiphop" id="opt3" class="hidden"/>
                            <span class="label2"></span>Hiphop
                        </label>
                        
                        <label for="opt4" class="radio">
                            <input type="radio" name="genre" value="ballad" id="opt4" class="hidden"/>
                            <span class="label2"></span>Ballad
                        </label>
                            
                        <label for="opt5" class="radio">
                            <input type="radio" name="genre" value="bgm" id="opt5" class="hidden"/>
                            <span class="label2"></span>Bgm
                        </label>
                        
                    </div>
                </div>  
                <div>  
                    <button class="buttonup" onclick="uploadfile()">
                        ...
                        <div class="inner">
                         ...
                         <label for="inp6" class="inp6">
                            <input name="price" type="number" id="inp6" placeholder="&nbsp;">
                            <span class="label6">price</span>
                            <svg width="120px" height="26px" viewBox="0 0 120 26">
                                <path d="M0,25 C21,25 46,25 74,25 C102,25 118,25 120,25"></path>
                            </svg>
                            <span class="border"></span>
